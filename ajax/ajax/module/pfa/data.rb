...
DATA_PFA = {
  exp:  {id:'exp', hname: 'EXPOSITION', start:0, end: 30, type: :part, inner: {
  ...
  dv1:  {id:'dv1', hname: 'DEVELOPPEMENT (PART I)', start:30, end:60, type: :part, inner: {
    t1:  {id:'t1',  hname: '1/3',         start:(40 - 2), end:(40 + 2), type: :noeud},
    cv:  {id:'cv',  hname: 'CdV', mark:'CV', start:(60 - 2), end:(60 + 2), type: :noeud}
  }},
  dv2:  {id:'dv2', hname: 'DEVELOPPEMENT (PART II)', start:60, end:90, type: :part, inner:{
  ...
  den:  {id:'den', hname: 'DENOUEMENT', start:90, end: 120, type: :part, inner:{
